        ...
        <div class="page-header__buttons">
            ...
            @can('delete', $building)
                <x-buttons.delete-with-modal
                    ...
                    warning="Это действие безвозвратно удалит данное здание а также все помещения относящиеся к данному зданию
                        и все оборудование в данных помещениях, включая ремонты этого оборудования и заявки на ремонт."
