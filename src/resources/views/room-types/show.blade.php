<x-admin-layout :title="'Тип помещений: ' . $roomType->name">
                                ...
                                <div class="overflow-hidden">
                                    ...
                                    <table class="min-w-full text-left text-sm font-light">
                                        ...
                                        >
                                            ...
                                            <td class="whitespace-nowrap px-6 py-4"> {{ $roomType->name }}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="overflow-hidden">
                                    ...
                                    <table class="min-w-full text-left text-sm font-light">
                                        ...
                                        <tr
                                            ...
                                            <td class="whitespace-nowrap px-6 py-4"> {{ $roomType->created_at }}</td>
                                        </tr>
                                        <tr
                                            class="border-b bg-white dark:border-neutral-500 dark:bg-neutral-600">
                                            <th scope="row" class="px-2 py-4 text-right">Последнее изменение:
                                            </th>
                                            <td class="whitespace-nowrap px-6 py-4"> {{ $roomType->updated_at }}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
