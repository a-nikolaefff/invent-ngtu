<x-layouts.app title="Редактирование ремонта" :centered="true" :overflowXAuto="false">
            ...
            <div class="form-wrapper">
                ...
                <div class="max-w-4xl">
                    ...
                    <x-forms.text-input id="shortDescription" name="short_description" type="text"
                                        :value="old('short_description', $repair->short_description)" required autocomplete="off"/>
