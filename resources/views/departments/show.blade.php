        ...
        <div class="page-header__buttons">
            ...
            @can('delete', $department)
                <x-buttons.delete-with-modal
                    question="Вы уверены, что хотите удалить данное подразделение?"
                    warning="Это действие безвозвратно удалит данное подразделения.
                        У всех существующих помещений данного подразделения, подразделение не будет задано.
                        У всех дочерних подразделений данного подразделения, родительское подразделение не будет задано."
