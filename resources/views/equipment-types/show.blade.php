<x-layouts.admin :centered="true" :title="'Тип оборудования: ' . $equipmentType->name">
        ...
        <div class="page-header__buttons">
            ...
            @can('delete', $equipmentType)
                <x-buttons.delete-with-modal
                    question="Вы уверены, что хотите удалить данный тип оборудования?"
                    warning="Это действие удалит данный тип оборудования. У всего существующего оборудования с данным типом тип станет не задан."
    ...
    <div class="content-block">
        ...
        <table class="standard-table standard-table_left-header">
            ...
            <tr>
                ...
                <td>
                    @if($equipmentType->model_color)
                        <div class="flex">
                            {{ $equipmentType->model_color }}
                            <span class="ml-2 inline-block w-5 h-5" style="background-color: {{ $equipmentType->model_color }}"></span>
                        </div>
                    @else
                        не задан
                    @endif
