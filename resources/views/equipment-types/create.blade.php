<x-layouts.admin title="Добавление нового типа оборудования" :centered="true" :overflowXAuto="false">
    ...
    <div class="content-block">
        ...
        <form method="POST"
            ...
            <div class="form-wrapper">
                ...
                <div class="pt-4">
                    <x-buttons.confirm>добавить тип оборудования</x-buttons.confirm>
                </div>
            </div>
        </form>
    </div>
